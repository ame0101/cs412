...
class CryptoIssue(models.Model):
    ...
    checked_at = models.DateTimeField(null=True, blank=True)  # Existing field

    # New field for issue deduplication
    issue_hash = models.CharField(max_length=64, unique=True, null=True, blank=True)
