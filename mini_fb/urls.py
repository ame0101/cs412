...
from .views import (
    ...
    UpdateStatusMessageView, ShowNewsFeedView, CreateFriendView,
    DeleteProfileView, ShowFriendSuggestionsView, RegistrationView
)

urlpatterns = [

    path('', ShowAllProfilesView.as_view(), name='show_all_profiles'),
    path('create_profile/', CreateProfileView.as_view(), name='create_profile'),  # Updated
    path('profile/<int:pk>/', ShowProfilePageView.as_view(), name='show_profile'),
    path('profile/update/', UpdateProfileView.as_view(), name='update_profile'),
    path('status/create_status/', CreateStatusMessageView.as_view(), name='create_status'),  # Updated
